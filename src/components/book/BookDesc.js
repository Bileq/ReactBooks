        ...
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-12 col-md-7 mt-md-0 mt-5 text-start text-md-justify text fs-6 pb-2">
                    ...
                    Integer aliquam maximus metus, nec volutpat nunc pretium et.
                    Ut mollis venenatis sem, {title} id posuere ligula
                    scelerisque id. Mauris et mi arcu.Morbi ultricies augue ac
                    ornare rutrum. Aenean tempor eu sem in ultrices.
                </div>
            </div>
        </div>
    );
